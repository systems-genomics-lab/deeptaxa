...
::: {.text-center}
<small>A stylized illustration of the gut-brain axis</small>
:::
...
DeepTaxa and evaluates whether that caution is warranted for this dataset. Using the DeepTaxa checkpoint,
mean genus confidence reaches 0.985 and 99 percent of reads are assigned at the genus rank.
To show that this is accuracy and not merely confidence, the same
