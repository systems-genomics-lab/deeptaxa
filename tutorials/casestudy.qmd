...
This tutorial reanalyzes an ALS gut-microbiome dataset [@hertzberg2021als] with DeepTaxa [@salah2026deeptaxa], cross-checks against SILVA [@quast2013silva], and revisits a PICRUSt2 functional claim [@douglas2020picrust2]. See the [References](references.qmd) page for the complete bibliography.
